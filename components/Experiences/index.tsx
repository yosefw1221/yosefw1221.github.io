      ...
      <ol className="relative border-l border-gray-200 dark:border-gray-700">
        ...
        <li className="mb-10 ml-4">
          ...
          <div className="text-base font-normal text-gray-500 dark:text-gray-400">
            ...
            <ol className="pl-4 list-disc pt-2">
              <li>
                Being part of the team, I was responsible to create
                user-friendly applications. designing the user interface,
                implementing the application logic.
              </li>
              <li>Maintaining and updating existing applications</li>
              <li>Gathering application Requirements</li>
              <li>Integrating with back-end services and api </li>
            </ol>
          </div>
        </li>
      </ol>
